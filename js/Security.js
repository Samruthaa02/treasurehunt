class Security {
    ...
    constructor(){
        ...
        this.access1.attribute("placeholder","Code1");
        ...
        this.access2.attribute("placeholder","Code2");
...
//add code for creating and positioning the third input box and button
        ...
        this.access3.attribute("placeholder","Code3");
        this.access3.position(110,350);
        this.access3.style('background', 'white'); 

        this.button3 = createButton('Check');
        this.button3.position(110,380);
